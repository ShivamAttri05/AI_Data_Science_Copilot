...
MODEL_PATH = "saved_models\api_model_20260413_131850.joblib"
...
def get_model_info():
    ...
    return {
        "model_class":   _MODEL_DATA.get("model_class"),
        "feature_names": _MODEL_DATA.get("feature_names", ['Age', 'Sex', 'ChestPainType', 'RestingBP', 'Cholesterol', 'RestingECG', 'MaxHR', 'ExerciseAngina', 'Oldpeak', 'ST_Slope']),
